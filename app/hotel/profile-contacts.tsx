...
const FormInput = ({ label, placeholder }: { label: string; placeholder: string }) => (
  <View className="mb-6">
    <Text className="mb-3 text-[15px] font-bold text-[#475569]">{label}</Text>
    <View className="rounded-xl border border-[#F1F5F9] bg-white px-4 py-4 shadow-sm shadow-slate-100">
      <TextInput
